...
<head>
  ...
  <link href="{{ asset('import/assets/img/digilogo.png') }}" rel="icon">
  <!-- Google Fonts -->
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <!-- <span class="d-none d-lg-block">DigitalStore</span> -->
                </a>
              </div><!-- End Logo -->
    ...
    @endif
                  ...
                  @csrf
                    ...
                    <div class="col-12">
                      ...
                      <button class="btn btn-primary btn-custom w-100" type="submit">Login</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="{{ route('signup') }}"> Create a Account</p>
                    </div>
                  </form>
