            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ route('signup') }}" class="row g-3 needs-validation" novalidate >
                  @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary btn-custom w-100" type="submit">Create Account</button>
                    </div>
                    <div class="col-12">
